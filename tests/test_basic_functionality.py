...
ap_params, gof_params = compute_slope(freq=freq_irasa, psd=psd_ap[0,:], fit_func='fixed')
ap_params
# %%
gof_params
# %% Lets check the knee
...
gof_params
# %%
ap_params, gof_params = compute_slope(freq=freq_irasa, psd=psd_ap[0,:], fit_func='knee')
ap_params
# %% 
gof_params
# %%

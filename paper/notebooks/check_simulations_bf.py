...
if reload:
   ...
   for f in all_files:
      ...
      cur_p = pd.concat([cur_f['specparam']['fixed']['periodic'],
                        cur_f['pyrasa']['fixed']['periodic']])#.dropna(axis=1)


      cur_ap = pd.concat([cur_f['specparam']['fixed']['aperiodic'],
                        cur_f['pyrasa']['fixed']['aperiodic']
                           ])#.dropna(axis=1)
...
sns.lineplot(df_ap_sim, x='sim_freq', 
               y='Exponent Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_ap_sim, x='sim_exp', 
               y='Exponent Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_ap_sim, x='sim_bw', 
               y='Exponent Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_ap_sim, x='sim_height', 
               y='Exponent Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
# %%
df_pivot = (df_ap_sim.reset_index()
                     .pivot_table(index=['method', 'sim_bw'], 
                                  columns='sim_height', 
                                  values='Exponent Δ'))
...
def plot_mesh_bw_h(data, key, ax):
   ...
   title = key
   extent = [y_labels.min(), y_labels.max(),
             x_labels.min(), x_labels.max(), ]

   mesh = ax.imshow(data2plot, 
                  aspect=1.4,
                  vmin=cur_d.min().min(), 
                  vmax=cur_d.max().max(),
                  interpolation='none',
...
cbar = f.colorbar(mesh,  ax=axs.ravel().tolist(), 
                  orientation='vertical', aspect=4., fraction=0.05)
cbar.set_ticks([np.round(df_pivot.min().min(), 2),
                     np.round(df_pivot.max().max(), 2)])
...
sns.violinplot(df_nona, x='method', 
               y='Center \n Frequency Δ', 
               hue='method',
               #split=True, 
               legend=False,
...
#%%
f, ax = plt.subplots(figsize=(14, 14), ncols=2, nrows=2)
sns.lineplot(df_nona, x='sim_freq', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_nona, x='sim_exp', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_nona, x='sim_height', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
f, ax = plt.subplots(figsize=(4,6))
sns.violinplot(df_p_cmb, x='method', 
               y='Center \n Frequency Δ', 
               hue='method',
               #split=True, 
               legend=False,
...
#%%
f, ax = plt.subplots(figsize=(14, 14), ncols=2, nrows=2)
sns.lineplot(df_p_cmb, x='sim_freq', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_p_cmb, x='sim_exp', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_p_cmb, x='sim_bw', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.lineplot(df_p_cmb, x='sim_height', 
               y='Center \n Frequency Δ', 
               hue='method',
               palette = palette,
               legend=False,
...
sns.violinplot(df_ap_sim, x='method', 
               y='Exponent Δ', 
               hue='method',
               #split=True, 
               legend=False,
